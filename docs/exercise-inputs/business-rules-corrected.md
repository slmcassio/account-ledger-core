...
Settle each account's eligible unpaid interest total at the end of Day 6, separately in AED and BHD. Positive totals credit; negative totals debit even into a negative balance; zero settles components without moving funds. This approved extension of BR10 carries no eligible negative total forward. Financial payments use reference Day 5 and both dates Day 6. E9 and adjustments booked on Day 6 cannot change their amounts. A Day 6 credit or debit enters Day 6 bases evaluated on Day 7.
