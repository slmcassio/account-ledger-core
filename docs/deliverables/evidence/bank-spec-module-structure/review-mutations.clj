...
(require '[account-ledger.authorization.logic.core :as authorization]
         '[account-ledger.ledger.ports.api-server :as ledger]
         '[account-ledger.system :as system]
         '[account-ledger.yield-fees.logic.transitions]
...
(let [mutation (first *command-line-args*)
      ...
      (case mutation
        ...
        "duplicate-response"
        {(ns-resolve 'account-ledger.yield-fees.logic.transitions 'original-event)
         (fn [result]
